    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="w-full rounded-md bg-teal-500 hover:bg-teal-400 text-zinc-950 shadow-md shadow-teal-500/20 hover:shadow-teal-500/40 transition-all duration-200 hover:scale-[1.02] font-medium py-2 text-sm"
        >
          Done
        </button>
      </Modal>
      ...
      <form onSubmit={submit} className="space-y-3">
        <div>
          ...
          <input
            ...
            placeholder="ci-prod"
            autoFocus
            className="w-full rounded-md bg-zinc-950 border border-zinc-800 px-2.5 py-1.5 text-sm focus:border-teal-600 focus:outline-none"
          />
        </div>
